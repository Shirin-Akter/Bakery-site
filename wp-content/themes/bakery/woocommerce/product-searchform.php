...
<form role="search" method="get" class="search-form woocommerce-product-search" action="<?php echo esc_url( home_url( '/'  ) ); ?>">
	<label class="screen-reader-text hide" for="woocommerce-product-search-field"><?php _e( 'Search for:', 'woocommerce' ); ?></label>
	...
	<input type="submit" class="hide" value="<?php echo esc_attr_x( 'Search', 'submit button', 'woocommerce' ); ?>" />
