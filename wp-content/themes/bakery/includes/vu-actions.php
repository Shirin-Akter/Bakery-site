<?php
	...
	function vu_init(){
		...
		wp_localize_script( 'bakery-main', 'vu_config',
			array(
				...
				'google_maps_api_key' => vu_get_option('google-map-api-key', '')
			)
		);
	...
	function vu_wp_footer(){
		...
		// Scripts
		wp_enqueue_script(array('bootstrap', 'owl-carousel', 'magnific-popup', 'scrollTo', 'parallax', 'placeholder-fallback', 'inview', 'counterup', 'waypoints', 'imagesloaded', 'bakery-main'));
	...
	function bakery_register_required_plugins() {
		$plugins = array(
			array(
				...
				'slug'                   => 'bakery-cpt',
				'source'                 => 'http://dl.milingona.co/bakery/1.3.7/bakery-cpt.zip',
				'required'               => true,
				'version'                => '1.1.9',
			...
			array(
				...
				'slug'                   => 'js_composer',
				'source'                 => 'http://dl.milingona.co/bakery/1.3.7/js_composer.zip',
				'required'               => true,
				'version'                => '5.0.1',
				'force_activation'       => false,
				'force_deactivation'     => false,
			...
			array(
				...
				'slug'                   => 'revslider',
				'source'                 => 'http://dl.milingona.co/bakery/1.3.7/revslider.zip',
				'required'               => true,
				'version'                => '5.3.1.5',
				'force_activation'       => false,
				'force_deactivation'     => false,
